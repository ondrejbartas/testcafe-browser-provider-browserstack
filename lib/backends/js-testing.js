...
var JSTestingBackend = function (_BaseBackend) {
            ...
            return _regenerator2.default.wrap(function _callee5$(_context5) {
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            workerTime = Date.now() - this.workers[id].started;
                        ...
                        case 6:
                            _context5.next = 8;
                            return (0, _delay2.default)(MINIMAL_WORKER_TIME - workerTime);
                                    ...
                                    return _regenerator2.default.wrap(function _callee6$(_context6) {
                                        while (1) {
                                            switch (_context6.prev = _context6.next) {
                                                case 0:
                                                    _context6.next = 2;
                                                    return (0, _requestApi2.default)(BROWSERSTACK_API_PATHS.screenshot(_this2.workers[id].id));
    ...
    JSTestingBackend.prototype.reportJobResult = function () {
        ...
        function reportJobResult(_x13, _x14, _x15, _x16) {
